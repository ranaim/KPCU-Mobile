package project.pageobject;
	...
	public class SmartAccountPage extends SeleniumUtils {
	    ...
	    @AndroidFindBy(xpath = "//android.widget.Button[contains(@resource-id,'accounts_transfer_out_btn')]")
	    ...
	    public void validate_SmartAccount_Details()
	    {
	    	defaultWait(20);
	    	logTitleMessage("Validate Smart Account Page :"); 
